...
var planetTypeData = [
	{
		...
		atmosphere: function( pnrg, insolation, radius, density, hydrographics ){
			if( hydrographics > 0 && insolation > 0.25 && insolation < 2 ){
				return pnrg.weighted(['Breathable', 'Filterable', 'Inert', 'Toxic', 'Corrosive', 'Trace'], [1,2,2,1,1,1]);
			} else {
				return pnrg.weighted(['Breathable', 'Filterable', 'Inert', 'Toxic', 'Corrosive', 'Trace'], [1,2,3,4,5,5]);
			}
		},
		HI
	},
